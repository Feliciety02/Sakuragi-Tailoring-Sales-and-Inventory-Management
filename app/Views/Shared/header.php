    ...
    <div class="user-profile">
      ...
      <?php endif; ?>
        ...
        function loadNotifCount() {
            fetch('/app/Controllers/notifications_api.php?action=count')
                .then(r => r.json())
                .then(data => {
        ...
        function markRead(id) {
            fetch('/app/Controllers/notifications_api.php?action=read&id=' + id).then(() => loadNotifCount());
        }
        function markAllRead() {
            fetch('/app/Controllers/notifications_api.php?action=read_all').then(() => { loadNotifCount(); loadNotifications(); });
        }
